...
namespace ShareDirectory_and_SetPermission
{
    ...
    {
        private static ManagementObject securityIdentfierObject;
        ...
        public static void ShareFolder(string FolderPath, string ShareName, string Description)
        {
            ...
            try
            {
                _ = Directory.CreateDirectory(strSharePath);
                ...
                _ = (uint)outputParameters.Properties["ReturnValue"].Value != 0
        ...
        public static void AddPermissions(string sharedFolderName, string domain, string userName)
        {
            ...
            if (!(securityDescriptor.Properties["DACL"].Value is ManagementBaseObject[] accessControlList))
            {
